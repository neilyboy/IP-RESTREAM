        ...
        >
          <Box sx={{ 
            ...
            <Button 
              variant="contained" 
              sx={{
                background: 'linear-gradient(45deg, #ff6b6b 30%, #ff3737 90%)',
            ...
            <motion.div variants={itemVariants}>
              <Box
                sx={{
                  ...
                  borderRadius: '12px',
                  border: '1px solid rgba(0, 212, 85, 0.2)',
                  boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)',
                }}
              >
                <Typography variant="subtitle2" sx={{ color: '#00d455', mb: 1, fontWeight: 600 }}>
                  Local Stream URL
                </Typography>
                <TextField
                  fullWidth
                  ...
                  InputProps={{
                    ...
                    sx: {
                      ...
                      '& .MuiOutlinedInput-notchedOutline': {
                        borderColor: 'rgba(0, 212, 85, 0.3)'
                      },
                      '&:hover .MuiOutlinedInput-notchedOutline': {
                        borderColor: 'rgba(0, 212, 85, 0.5)'
                      },
                      '&.Mui-focused .MuiOutlinedInput-notchedOutline': {
                        borderColor: 'rgba(0, 212, 85, 0.8)'
                      }
                    }
                  }}
                  sx={{ mb: 1 }}
