    ...
    <Box sx={{ 
      ...
      {loading && (
        <Box sx={{ 
          ...
          <CircularProgress size={60} thickness={4} sx={{ color: theme.palette.success.main, mb: 2 }} />
          <Typography variant="body1" sx={{ color: theme.palette.text.primary, textAlign: 'center', px: 2 }}>
            {loadingTimeout 
